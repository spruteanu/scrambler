...
class ValueDefinition {
    ...
    ValueDefinition incremental(Number value, Number step = null) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(value.class), Incremental.of(value, step))
        return this
    }
    ...
    ValueDefinition random(Number minimum = null, Number maximum = null) {
        ...
        registerPredicateValue(new TypePredicate(value.class), org.prismus.scrambler.value.Random.of(minimum, maximum))
        return this
    }
    ...
    ValueDefinition incremental(Date value, Integer step = null, Integer calendarField = null) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(value.class), Incremental.of(value, step, calendarField))
        return this
    }
    ...
    ValueDefinition random(Date value, Date minimum = null, Date maximum = null) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(Date), org.prismus.scrambler.value.Random.of(value, minimum, maximum))
        return this
    }
    ...
    ValueDefinition incremental(String value, Integer index) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(value.class), Incremental.of(value, index))
        return this
    }
    ...
    ValueDefinition incremental(String value, String pattern = null, Integer index = null) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(String), Incremental.of(value, pattern, index))
        return this
    }
    ...
    ValueDefinition random(String value, Integer count = null, Boolean includeLetters = null, Boolean includeNumbers = null) {
        Util.checkNullValue(value)
        registerPredicateValue(new TypePredicate(String), org.prismus.scrambler.value.Random.of(value, count, includeLetters, includeNumbers))
        return this
    }
    ...
    ValueDefinition randomOf(Collection values) {
        ...
        registerPredicateValue(new TypePredicate(value.class), org.prismus.scrambler.value.Random.randomOf(values))
        return this
    }
