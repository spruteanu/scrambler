...
/**
 * Increments date by seconds/minutes/hours/weeks/month/years using either provided or default calendar
 *
...
public class IncrementalDate extends ConstantData<Date> {
    ...
    public IncrementalDate(Date date) {
        this(date, DEFAULT_CALENDAR_FIELD, DEFAULT_STEP);
    }

    public IncrementalDate(Date date, Integer step) {
        this(date, DEFAULT_CALENDAR_FIELD, step);
    }

    public IncrementalDate(Date date, Integer calendarField, Integer step) {
        super(date);
