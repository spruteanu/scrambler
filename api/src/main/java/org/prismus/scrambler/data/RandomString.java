...
public class RandomString extends ConstantData<String> {
    ...
    public RandomString(String obj) {
        this(obj, null);
    }

    public RandomString(String obj, Integer count) {
        super(obj);
        this.template = obj;
        this.count = count;
    ...
    protected String doNext() {
        ...
        final int count = checkCount(result);
        result = random(count, 0, result.length(), true, true, result.toCharArray());
        return result;
    }

    Integer checkCount(String text) {
