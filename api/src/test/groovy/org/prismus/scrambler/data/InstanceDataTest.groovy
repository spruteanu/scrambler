...
class InstanceDataTest extends Specification {
    ...
    void 'instance creation'(Object value, Class expectedType) {
        given:
        final instance = new InstanceData().usingInstance(value)
...
//        null != obj.writeOnly
    ...
    void 'instance creation with arguments'(Object value, Class instanceType,
        ...
        given:
        final instance = new InstanceData().usingInstance(value).withConstructorData(constructorValues)
    ...
    void 'test lookup property definitions'() {
        given:
        final instance = new InstanceData<Order>().usingInstance(new Order())
        ...
        ArrayList == propertyDescriptors.get('items')?.object?.class
    }

    void 'test populate instance with properties'() {
        given:
        final instance = new InstanceData<School>().usingInstance(new School()).build(null)
